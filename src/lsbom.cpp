...
int main(int argc, char *argv[]) {
  ...
  for (int i = optind; i < argc; i++) {
    ...
    BOMHeader *header = (BOMHeader *)ddata;
    ...
    indexHeader = (BOMBlockTable *)(ddata + ntohl(header->indexOffset));

    // Process vars
    BOMVars *vars = (BOMVars *)(ddata + ntohl(header->varsOffset));
